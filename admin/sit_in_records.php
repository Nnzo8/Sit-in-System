...
$sql = "SELECT 
            ...
            ds.purpose,
            ds.time_in,
            COALESCE(ds.time_out, CASE WHEN ds.status = 'completed' THEN ds.date_updated ELSE NULL END) as time_out,
            ds.status,
            ds.date_updated,
            s.First_Name, 
            s.Last_Name, 
        ...
        WHERE (ds.status = 'completed' AND (ds.time_out IS NOT NULL OR ds.date_updated IS NOT NULL))

    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
                ...
                <div class="space-y-2">
                    <a href="students.php" class="block text-blue-600 hover:underline">
                        <i class="fas fa-users mr-2"></i>Manage Students
                    </a>
                    <a href="sit_in_records.php" class="block text-blue-600 hover:underline">
                        <i class="fas fa-clipboard-list mr-2"></i>View Sit-in Records
                    </a>
                    <a href="announcements.php" class="block text-blue-600 hover:underline">
